...
function buildSteps(options) {
  ...
  steps.push(
    ...
    },
    {
      ...
      purpose: "Generate a one-page field closeout queue from the latest action board, requirements backlog, and gate classification.",
      doneWhen: "Quickstart lists env keys, runtime prerequisites, owner queue, phase queue, command queue, and source backlog.",
    },
    {
    ...
    },
    {
      ...
      command: npm,
      args: ["run", "field:closeout-quickstart", "--", `--base-url=${baseUrl}`, `--generated-by=${reviewer}`, `--site-name=${siteName}`],
      purpose: "Refresh quickstart from the final indexed action board and requirements backlog.",
      doneWhen: "Quickstart open action count matches the final indexed action board and source backlog.",
    },
    {
    ...
    },
    {
      ...
      doneWhen: "Quickstart source refs point to the latest final status, action board, classification, and requirements backlog before packaging.",
    },
    {
