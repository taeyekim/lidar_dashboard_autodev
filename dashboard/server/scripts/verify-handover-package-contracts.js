...
[
  ...
  "itemCount",
  "ownerCount",
  "REQUIREMENT_COVERAGE_DEFINITIONS",
  "buildRequirementsCoveragePacket",
  "requirementsCoveragePacket",
  "Requirements Coverage Packet",
  "Requirement area count",
  "Evidence-referenced area count",
  "Field-review area count",
  "Missing-evidence area count",
  "docs/ops/delivery-evidence-matrix.md",
  "API And Swagger",
  "DB And Prisma",
  "Frontend Control UI",
  "Traffic Statistics",
...
assertIncludes(runbook, "handover:package --reuse-existing-evidence", "delivery runbook");
assertIncludes(runbook, "orchestrator optimization", "delivery runbook");
assertIncludes(runbook, "not a standalone final-close", "delivery runbook");
...
assertIncludes(matrix, "handover:package --reuse-existing-evidence", "delivery evidence matrix");
assertIncludes(matrix, "already been regenerated in the same orchestrated run", "delivery evidence matrix");
...
assertIncludes(matrix, "artifacts/final-gate-classification/<timestamp>/manifest.json", "delivery evidence matrix");
assertIncludes(matrix, "final bundle handoff", "delivery evidence matrix");
assertIncludes(matrix, "final gate classification", "delivery evidence matrix");
