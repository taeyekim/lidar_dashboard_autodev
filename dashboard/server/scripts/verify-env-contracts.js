...
[
  ...
  [acceptanceChecklist, "field:closeout-quickstart", "acceptance checklist"],
  [acceptanceChecklist, "artifacts/field-closeout-quickstart/<timestamp>/manifest.json", "acceptance checklist"],
  [acceptanceChecklist, "Safe .env Patch Block", "acceptance checklist"],
  [acceptanceChecklist, "field:requirements-backlog", "acceptance checklist"],
  [acceptanceChecklist, "artifacts/field-requirements-backlog/<timestamp>/manifest.json", "acceptance checklist"],
  [acceptanceChecklist, "Batched unresolved field questions", "acceptance checklist"],
  ...
  [deliveryRunbook, "field:requirements-backlog", "delivery runbook"],
  [deliveryRunbook, "artifacts/field-requirements-backlog/<timestamp>/manifest.json", "delivery runbook"],
  [deliveryRunbook, "itemCount", "delivery runbook"],
  [deliveryRunbook, "field:closeout-quickstart", "delivery runbook"],
  [deliveryRunbook, "artifacts/field-closeout-quickstart/<timestamp>/manifest.json", "delivery runbook"],
  [deliveryRunbook, "Requirements Backlog Summary", "delivery runbook"],
  [deliveryRunbook, "Safe .env Patch Block", "delivery runbook"],
  [deliveryRunbook, "local:verification", "delivery runbook"],
  [deliveryRunbook, "artifacts/local-verification/<timestamp>/manifest.json", "delivery runbook"],
  ...
  [deliveryEvidenceMatrix, "Field Closeout Quickstart", "delivery evidence matrix"],
  [deliveryEvidenceMatrix, "field:closeout-quickstart", "delivery evidence matrix"],
  [deliveryEvidenceMatrix, "Field Requirements Backlog", "delivery evidence matrix"],
  [deliveryEvidenceMatrix, "field:requirements-backlog", "delivery evidence matrix"],
  [deliveryEvidenceMatrix, "local:verification", "delivery evidence matrix"],
  [deliveryEvidenceMatrix, "artifacts/local-verification/<timestamp>/manifest.json", "delivery evidence matrix"],
  ...
  [runtimeEvidenceScript, "RUNTIME_SMOKE_COVERAGE", "runtime evidence script"],
  [runtimeEvidenceScript, "buildRuntimeSmokeCoverage", "runtime evidence script"],
  [runtimeEvidenceScript, "runtimeSmokeCoverage", "runtime evidence script"],
  [runtimeEvidenceScript, "Runtime Smoke Coverage", "runtime evidence script"],
  [runtimeEvidenceScript, "buildRuntimeEvidenceStatus", "runtime evidence script"],
  [runtimeEvidenceScript, "manifest.status", "runtime evidence script"],
  [runtimeEvidenceScript, "requiredFailures", "runtime evidence script"],
  [runtimeEvidenceScript, "reviewReasons", "runtime evidence script"],
  [runtimeEvidenceScript, "runtime smoke failed", "runtime evidence script"],
  [runtimeEvidenceScript, "runtime smoke was skipped", "runtime evidence script"],
  [runtimeEvidenceScript, "nginx-health-security", "runtime evidence script"],
  [runtimeEvidenceScript, "swagger-entrypoint", "runtime evidence script"],
  [runtimeEvidenceScript, "auth-cookie-csrf", "runtime evidence script"],
  [runtimeEvidenceScript, "device-ingest-key", "runtime evidence script"],
  [runtimeEvidenceScript, "wrongway-lifecycle", "runtime evidence script"],
  [runtimeEvidenceScript, "control-board-frame", "runtime evidence script"],
  [runtimeEvidenceScript, "operator-kpis", "runtime evidence script"],
  [runtimeEvidenceScript, "coveredAreaCount", "runtime evidence script"],
  [runtimeEvidenceScript, "reviewAreaCount", "runtime evidence script"],
  [runtimeEvidenceScript, "skippedAreaCount", "runtime evidence script"],
  ...
  [fieldEnvCatalog, "WRONGWAY_LEVEL2_ESCALATION_ENABLED", "field env catalog"],
  [fieldEnvCatalog, "WRONGWAY_LEVEL2_MIN_CONSECUTIVE_COUNT", "field env catalog"],
  [fieldEnvCatalog, "WRONGWAY_LEVEL2_MIN_CONFIDENCE", "field env catalog"],
  [fieldEnvCatalog, "Dashboard-side level-2 escalation approval", "field env catalog"],
