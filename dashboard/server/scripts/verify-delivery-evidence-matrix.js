...
[
  ...
  "npm run local:verification",
  "npm run completion:audit",
  "npm run handover:index",
  "npm run field:closure-plan",
  "npm run handover:package",
  "npm run field:closeout-quickstart",
  "npm run field:requirements-backlog",
  "npm run final:bundle-handoff",
  ...
  "npm run manual:evidence-readiness",
  "artifacts/final-status/<timestamp>/manifest.json",
  "artifacts/final-status/<timestamp>/manifest.md",
  "artifacts/manual-evidence-readiness/<timestamp>/manifest.json",
  "artifacts/manual-evidence-readiness/<timestamp>/manifest.md",
  "artifacts/delivery/<timestamp>/runtime/",
  "artifacts/delivery/<timestamp>/security/",
  "artifacts/local-verification/<timestamp>/manifest.json",
  "artifacts/local-verification/<timestamp>/manifest.md",
  ...
  "artifacts/field-closeout-quickstart/<timestamp>/manifest.json",
  "artifacts/field-requirements-backlog/<timestamp>/manifest.json",
  "artifacts/final-bundle-handoff/<timestamp>/manifest.json",
  ...
  "replacement-owner/recheck follow-ups",
  ...
  "fresh delivery/readiness/acceptance/security/index/closure/classification references",
...
[
  ...
  [serverPackageJson, "verify-lidar-rehearsal-contracts.js", "server verify chain"],
  [serverPackageJson, "verify-control-board-field-rehearsal-contracts.js", "server verify chain"],
  [serverPackageJson, "verify-db-field-rehearsal-contracts.js", "server verify chain"],
  ...
  [deliveryEvidence, "formatFieldRehearsalMetadata", "delivery evidence generator"],
  [deliveryEvidence, "unavailableAcceptance", "delivery evidence generator"],
  [deliveryEvidence, "replacementOwner", "delivery evidence generator"],
  [deliveryEvidence, "targetRecheckDate", "delivery evidence generator"],
  [deliveryEvidence, "ownerStatus", "delivery evidence generator"],
  [deliveryEvidence, "recheckStatus", "delivery evidence generator"],
  ...
  [deliveryEvidence, "reuse-existing-companions", "delivery evidence generator"],
  [deliveryEvidence, "reuseExistingCompanions", "delivery evidence generator"],
  [deliveryEvidence, "reusedExistingEvidence", "delivery evidence generator"],
  ...
  [deliveryEvidence, "COMPLETION_AUDIT_EVIDENCE", "delivery evidence generator"],
  [deliveryEvidence, "HANDOVER_INDEX_EVIDENCE", "delivery evidence generator"],
  [deliveryEvidence, "FIELD_CLOSURE_EVIDENCE", "delivery evidence generator"],
  [deliveryEvidence, "FIELD_READINESS_EVIDENCE", "delivery evidence generator"],
  [deliveryEvidence, "HANDOVER_PACKAGE_EVIDENCE", "delivery evidence generator"],
  ...
  [deliveryRunbook, "Field Rehearsal Follow-ups", "delivery runbook"],
  [deliveryRunbook, "Field Rehearsal Follow-up Actions", "delivery runbook"],
  [deliveryRunbook, "Field Evidence Follow-ups", "delivery runbook"],
  [deliveryRunbook, "replacement owner", "delivery runbook"],
  [deliveryRunbook, "target recheck date", "delivery runbook"],
  ...
  [acceptanceChecklist, "LIVE_TCP_APPROVAL_REQUIRED", "acceptance checklist"],
  [acceptanceChecklist, "liveApproved", "acceptance checklist"],
  [acceptanceChecklist, "Field Rehearsal Follow-ups", "acceptance checklist"],
  [acceptanceChecklist, "Field Rehearsal Follow-up Actions", "acceptance checklist"],
  [acceptanceChecklist, "Field Evidence Follow-ups", "acceptance checklist"],
  [acceptanceChecklist, "--replacement-owner", "acceptance checklist"],
  [acceptanceChecklist, "--target-recheck-date", "acceptance checklist"],
