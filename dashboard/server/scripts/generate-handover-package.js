...
function latestEvidenceRefs() {
  return {
    ...
    fieldCloseoutQuickstart: readLatestJsonManifest("artifacts/field-closeout-quickstart")?.path || null,
    fieldRequirementsBacklog: readLatestJsonManifest("artifacts/field-requirements-backlog")?.path || null,
    localVerification: readLatestJsonManifest("artifacts/local-verification")?.path || null,
...
function buildMarkdown(manifest) {
  return [
    ...
    `- Field closeout quickstart: ${manifest.evidenceRefs.fieldCloseoutQuickstart || "missing"}`,
    `- Field requirements backlog: ${manifest.evidenceRefs.fieldRequirementsBacklog || "missing"}`,
    `- Local verification: ${manifest.evidenceRefs.localVerification || "missing"}`,
