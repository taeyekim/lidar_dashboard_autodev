...
- `artifacts/handover-package/<timestamp>/manifest.json` and `manifest.md` from `npm run handover:package`; confirm `Field Evidence Follow-ups` matches the latest audit/index/closure follow-up information.
