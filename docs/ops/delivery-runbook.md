...
- `artifacts/handover-index/<timestamp>/manifest.json` and `artifacts/handover-index/<timestamp>/manifest.md` from `npm run handover:index`
- `artifacts/field-closure-plan/<timestamp>/manifest.json` and `manifest.md` from `npm run field:closure-plan`
- `artifacts/handover-package/<timestamp>/manifest.json` and `manifest.md` from `npm run handover:package`
