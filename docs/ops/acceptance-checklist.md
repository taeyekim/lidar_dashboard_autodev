...
- [ ] `npm run field:owner-briefs -- --base-url=http://localhost:8080 --generated-by="$env:FIELD_REVIEWER" --site-name="$env:FIELD_SITE_NAME"` creates `artifacts/field-owner-briefs/<timestamp>/manifest.json` plus per-owner markdown brief files generated from the latest field action board, including owner phase counts.
