...
- [ ] `npm run handover:package` refreshes delivery evidence, completion audit, handover index, and field closure plan in order, then writes `artifacts/handover-package/<timestamp>/manifest.json` plus `manifest.md`.
